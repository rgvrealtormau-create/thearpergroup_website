import { flipCalculator, resources } from '../../../../lib/content';
...
export async function generateMetadata({ params }) {
  const c = flipCalculator[params.lang];
  return { title: c.metaTitle, description: c.metaDesc, alternates: pageAlternates(params.lang, 'resources/flip-calculator') };
}

export default function FlipCalculatorPage({ params }) {
  const lang = params.lang;
  const c = flipCalculator[lang];
  ...
  const breadcrumb = breadcrumbSchema([
    ...
    { name: c.title, url: `${BUSINESS.url}/${lang}/resources/flip-calculator` },
  ]);
  ...
  return (
    <>
      ...
      <section className="wrap py-16 md:py-20">
        <FlipCalculator lang={lang} copy={c} />
      </section>
