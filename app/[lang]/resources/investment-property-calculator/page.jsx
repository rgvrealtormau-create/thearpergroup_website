import { investmentProperty, resources } from '../../../../lib/content';
...
export async function generateMetadata({ params }) {
  ...
  return { title: c.metaTitle, description: c.metaDesc, alternates: pageAlternates(params.lang, 'resources/investment-property-calculator') };
}
...
export default async function InvestmentPropertyCalculatorPage({ params }) {
  ...
  const breadcrumb = breadcrumbSchema([
    ...
    { name: c.title, url: `${BUSINESS.url}/${lang}/resources/investment-property-calculator` },
  ]);
